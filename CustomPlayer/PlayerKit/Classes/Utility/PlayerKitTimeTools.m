...
+ (NSMutableAttributedString *)processingTimeAttributedString:(NSString *)processingTimeString
    ...
    [attribuedString addAttribute:NSForegroundColorAttributeName value:(id)[UIColor whiteColor] range:[processingTimeString rangeOfString:playingTimeString]];
    [attribuedString addAttribute:NSForegroundColorAttributeName value:(id)[UIColor colorWithWhite:0.820 alpha:0.500] range:[processingTimeString rangeOfString:totalTimeString]];
